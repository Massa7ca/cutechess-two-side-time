	  ...
	  m_isValid(true)
{
    ...
    ui->white_timeControlBtn->setText(m_timeControl[Chess::Side::White].toVerboseString());
    ui->black_timeControlBtn->setText(m_timeControl[Chess::Side::Black].toVerboseString());
